          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input id="password" name="password" type="password" autoComplete="current-password" required value={password} onChange={e => setPassword(e.target.value)} className="focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-10 sm:text-sm border-gray-300 rounded-md" placeholder="Enter your password" />
              </div>
            </div>
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-sm text-blue-700">
                    This is a demo app. Any valid email and password combination
                    will work.
                  </p>
                </div>
              </div>
